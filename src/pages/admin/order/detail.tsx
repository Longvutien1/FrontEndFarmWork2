...
import { getListOrder, orderById, updateOrder } from '../../../features/Slide/orderSlide';
  ...
  return (
    <div>
        ...
        <Typography.Title level={2} style={{ margin: "15px 0" }}>
          ...
          {/* thong tin  order */}
          <h2 style={{margin:"auto", textAlign:"center", paddingBottom:"10px"}}>Đơn hàng: {orderId?.id}, Trạng thái: {orderId?.status}</h2>
